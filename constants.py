...
# 追加ツール（優先トップ3）
ANSWER_WITH_LLM_TOOL_NAME = "answer_with_llm_tool"
ANSWER_WITH_LLM_TOOL_DESCRIPTION = "一般的な質問への回答や文章生成を行う汎用LLMツール"

SUMMARIZE_TOOL_NAME = "summarize_tool"
SUMMARIZE_TOOL_DESCRIPTION = "長文や会話を要約するためのツール。議事録やメール下書きの生成に使用します"

SENTIMENT_ANALYSIS_TOOL_NAME = "sentiment_analysis_tool"
SENTIMENT_ANALYSIS_TOOL_DESCRIPTION = "顧客メッセージの感情分析を行い、ポジティブ/ネガティブ/ニュートラルを返すツール"

# 全データ横断検索ツール
AGGREGATE_KB_TOOL_NAME = "aggregate_kb_tool"
AGGREGATE_KB_TOOL_DESCRIPTION = "社内の全データ（会社/サービス/顧客）を横断して検索し、要点をまとめて返すツール"
