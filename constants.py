...
ANSWER_WITH_LLM_TOOL_DESCRIPTION = "汎用的な自然言語生成・推論を行うためのTool。例: 文面生成、補足説明。"
SUMMARIZE_TOOL_NAME = "summarize_tool"
SUMMARIZE_TOOL_DESCRIPTION = "長文を要約して短く返すTool（議事録やメール下書き用）。"
SENTIMENT_ANALYSIS_TOOL_NAME = "sentiment_analysis_tool"
SENTIMENT_ANALYSIS_TOOL_DESCRIPTION = "顧客メッセージの感情（ポジティブ/ネガティブ/ニュートラル）を判定するTool。"

# 全データ横断検索Tool
AGGREGATE_KB_TOOL_NAME = "aggregate_kb_tool"
AGGREGATE_KB_TOOL_DESCRIPTION = "会社・サービス・顧客を横断して社内データ全体を検索し、要点をまとめて返すTool。"
